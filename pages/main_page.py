...
class MainPage(BasePage):
    ...
    @allure.step("Wait for and assert current URL contains: {substring}")
    def wait_and_assert_url_contains(self, substring: str):
        """Ожидает и проверяет, что URL содержит substring"""
